...
CREATE TABLE CAU_HOI (
	...
	Vi_tri_dap_an_dung		varchar(4)  not null default 0,
...
SELECT * 
FROM (DE_THI_BAO_GOM_CAU_HOI AS D JOIN PHAN_CAU_HOI AS PCH ON D.Ma_cau_hoi = PCH.Ma_cau_hoi) LEFT JOIN PHAN_TRA_LOI AS PTL ON PTL.Ma_cau_hoi = D.Ma_cau_hoi
WHERE Ma_de_thi = 'CO12A1102'
